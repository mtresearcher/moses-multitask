...
namespace Optimizer {
  ...
  class Hildreth {
    public :
	  static vector<float> optimise (const vector<ScoreComponentCollection>& a, const vector<float>& b) {
	  ...
	  static vector<float> optimise (const vector<ScoreComponentCollection>& a, const vector<float>& b, float C) {
	  	size_t i;
	  	int max_iter = 10000;
	  	float eps = 0.00000001;
	  	float zero = 0.000000000001;
